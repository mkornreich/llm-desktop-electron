...
const SCHEMA = [
  ...
  { group: "OpenAI model", file: ".openai-model", key: "OPENAI_CLASSIFIER_MODEL", type: "text",
    ...
    label: "Safety-classifier model",
    help: "The Bash prefix-detection call that runs before risky actions. Latency-sensitive; a small model is the point. Measured accuracy: gpt-4.1-mini 12/14, gpt-5.4 and gpt-5.3-codex 13/14." },
